...
async def ytdl(_, message):
    ...
    try:
        ...
        await message.reply_text("`**Nu mai pot gasi nimic pe YouTube...** 😔 \n__Posibil ca YouTube sa ne fi blocat ip de la server__ \n#error`")
        return
    buttons = InlineKeyboardMarkup(list(create_buttons(formats)))
    sentm = await message.reply_text("Caut pe Youtube 🔎 🔎 🔎")
    try:
